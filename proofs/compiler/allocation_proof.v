...
Section PROOF.
  ...
  Proof.
    ...
    case: s2 => scs2 sm2 svm2 _ Hc Hse _ Hc' _ Hw r1 [] //= a2 c2 e2 ei2 c2' r2 vm1 Hvm1.
    rewrite /check_i -/check_I.
    ...
    have : check_i (Cwhile a c e ei c') (Cwhile a2 c2 e2 ei2 c2') r2' = ok re.
  ...
  Proof.
    ...
    case: s2 => scs2 sm2 svm2 _ Hc Hse r1 [] //= a2 c2 e2 ei2 c2' r2 vm1 Hvm1.
    rewrite /check_i -/check_I.
